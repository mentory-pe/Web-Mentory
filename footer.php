<footer>
    <link rel="stylesheet" href="<?php echo get_template_directory_uri(); ?>/assets/css/footer.css"type="text/css">
    <div class="main-footer">
        ...
        <div class="footer_sub">
        <div class="link_zone">PROGRAMAS</div>
            <div class="link_zone_items">
                <div class="link_zone_item"><a href="">Mantenimiento</a></div>
                <div class="link_zone_item"><a href="">Calidad</a></div>
                <div class="link_zone_item"><a href="">Minería</a></div>
                <div class="link_zone_item"><a href="">Seguridad</a></div>
            </div>
        </div>
