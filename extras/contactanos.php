            ...
            <form action="post" class="information-form">
                ...
                <div class="form-checks">
                    <label>
                        ...
                        Lorem ipsum dolor sit amet consectetur adipisicing elit. Labore harum, porro est vitae hic cum reiciendis nostrum laudantium assumenda eligendi id temporibus.
                    </label>
                    <br>
                    <br>
                    <label>
                        <input type="checkbox" name="check1" required>
                        Lorem ipsum dolor sit amet, consectetur adipisicing elit. Accusamus eligendi ut ipsam cum minus ab, quaerat accusantium rem reprehenderit nulla deserunt mollitia corrupti, atque velit quis repellat unde asperiores at.
                    </label>
                </div>
