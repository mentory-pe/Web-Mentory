    ...
    <div class="area_container">
        <div class="area_section">
            ...
            <div class="area_section_title">
                Explorar por Áreas
                <img style="position: absolute; transform: translate(-160px, 60px);"
                        ...
                        <div class="card_program">
                            ...
                            <div class="card_program_txtcont">
                                ...
                                <div class="card_program_txt_desc">
                                    ...
                                    habilidades en
                                    el diagnóstico y mantenimiento de transformadores</div>
    ...
    <div class="empresas_section">
        <div class="empresas_section_container">
            <div class="empresas_section_title">
                ...
                Empresas que <br>
                        <img style="transform: translate(50px, -10px); position: absolute;" src="<?php echo get_template_directory_uri(); ?>/assets/images/index/vector_masterclass.png" alt="vector_masterclass">
                confían en nosotros
    ...
    <div class="masterclass_section">
        <div class="masterclass_section_container">
            <div class="masterclass_section_title">
                ...
                <img style="position: absolute; transform: translate(-565px, 65px);"
        ...
        <div class="logros_zone_container">
            <div class="logros_zone_letras">
                <div class="logros_zone_letras_title">
                    NUESTROS LOGROS
                    <img style="position: absolute; transform: translate(-195px, 65px);"
                    src="<?php echo get_template_directory_uri(); ?>/assets/images/index/vector_masterclass.png" alt="">
                </div>
                <div class="logros_zone_letras_txt">Números que cuentan nuestra historia de progreso constante y dedicación excepcional</div>
                <div class="logros_zone_letras_cards">
                    <div class="logros_zone_letras_item">

                        <div class="logros_zone_letras_item_unitario">
                            <div class="logros_zone_letras_logo"><img src="<?php echo get_template_directory_uri(); ?>/assets/images/index/logro1.png" alt=""></div>
                        ...
                        <div class="logros_zone_letras_item_unitario">
                            <div class="logros_zone_letras_logo"><img src="<?php echo get_template_directory_uri(); ?>/assets/images/index/logro2.png" alt=""></div>
                            <div class="logros_zone_letras_txts">
                    ...
                    <div class="logros_zone_letras_item_unitario">
                        ...
                        <div class="logros_zone_letras_logo"><img src="<?php echo get_template_directory_uri(); ?>/assets/images/index/logro3.png" alt=""></div>
                            <div class="logros_zone_letras_txts">
                        ...
                        <div class="logros_zone_letras_item_unitario">
                            <div class="logros_zone_letras_logo"><img src="<?php echo get_template_directory_uri(); ?>/assets/images/index/logro4.png" alt=""></div>
                            <div class="logros_zone_letras_txts">
    ...
    <div class="testimonios_zone">
        <div class="testimonios_zone_container">
            ...
            <div class="testimonios_zone_title">
                <img style="position: absolute; transform: translate(100px, 65px);" src="<?php echo get_template_directory_uri(); ?>/assets/images/index/vector_testimonios.png" alt="">
                    ...
                    <div>
                        <div class="card_testimonio">
                            <div class="card_testimonio_img">
                                <img src="<?php echo get_template_directory_uri(); ?>/assets/images/index/Desktop.png" alt="">
                            </div>
                            <div class="card_testimonio_personal">
                                <div class="card_testimonio_personal_img">
                                    <div><img src="<?php echo get_template_directory_uri(); ?>/assets/images/index/teacher_example.png" alt=""></div>
                                ...
                                <div class="card_testimonio_personal_comilla">
                                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/index/comillas.png" alt="">
                                </div>
                            </div>
            ...
            <div class="contact_zone_img">
                ...
                <div class="contact_zone_txtdireccion">
                    ...
                    <a href="" style="text-decoration: none;"><button class="contact_zone_btndireccion" >
                        ...
                        <img style="transform: translate(20px, 0px);" src="<?php echo get_template_directory_uri(); ?>/assets/images/index/arrowbtn_contact.png" alt="">
                    </button></a>
                </div>
            </div>
            <div class="contact_zone_card_form">
            <img style="position: absolute; transform: translate(-560px, -140px);" src="<?php echo get_template_directory_uri(); ?>/assets/images/index/elipse1.png" alt="">
            <img style="position: absolute; transform: translate(-450px, -30px);" src="<?php echo get_template_directory_uri(); ?>/assets/images/index/elipse2.png" alt="">
            <img style="position: absolute; transform: translate(-520px, 120px);" src="<?php echo get_template_directory_uri(); ?>/assets/images/index/elipse3.png" alt="">
                <div class="contact_zone_card_form_title">
                    Suscríbete para recibir actualizaciones
                    Cada nuevo programa
                </div>
                <div class="contact_zone_card_form_subtitle">
                    Más de 20k+ estudiantes aprenden diariamente con Mentory. Suscríbete para enterarte de nuevos programas.
                </div>
                <div class="contact_zone_card_form_input">
                    <input type="text" placeholder="Correo">
                    <button>Suscribirme</button>
                </div>
                <img style="position: absolute; transform: translate(550px, -120px);" src="<?php echo get_template_directory_uri(); ?>/assets/images/index/elipse4.png" alt="">
                <img style="position: absolute; transform: translate(450px, -20px);" src="<?php echo get_template_directory_uri(); ?>/assets/images/index/elipse5.png" alt="">
                <img style="position: absolute; transform: translate(560px, 140px);" src="<?php echo get_template_directory_uri(); ?>/assets/images/index/elipse6.png" alt="">
            </div>
        </div>
    </div>
</section>
